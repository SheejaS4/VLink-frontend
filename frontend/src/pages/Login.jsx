...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#0f172a] font-sans overflow-hidden">
      {/* Left Panel */}
      <div className="w-full md:w-1/2 flex flex-col items-center md:items-start justify-center bg-[#0f172a] px-8 py-8 md:py-12 md:pl-12 md:pr-6">
        {/* Logo and company name */}
        <div className="flex items-center mb-8 md:mb-12 w-full">
          <img src={logoProfile} alt="Logo" className="h-10 w-10 mr-3" />
          <span className="text-2xl font-bold text-white tracking-wide">VLink</span>
        </div>
        {/* Illustration */}
        <img
          src={Signin}
          alt="Sign in illustration"
          className="w-[100%] max-w-sm md:max-w-sm mx-auto mb-8 md:mb-10"
        />
        {/* Motivational quotes */}
        <div className="w-full text-center md:text-center mt-4">
          <p className="text-lg md:text-xl text-blue-200 font-semibold mb-2">
            "Unlock your productivity. Connect. Collaborate. Succeed."
          </p>
          <p className="text-base text-[#94a3b8]">
            "Every great journey begins with a single sign in."
          </p>
        </div>
      </div>
      {/* Right Panel (Login Form) */}
      <div className="w-full md:w-1/2 flex justify-end items-center">
        {/* Existing login form container, unchanged */}
